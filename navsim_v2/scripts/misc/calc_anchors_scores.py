...
def convert_one(metric_cache_path: str):
    new_metric_path = Path(metric_cache_path.replace('train_metric_cache_v2_pruned', 'anchors_scores'))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--csv_path",
        type=str,
        default="/scratch/linhan/train_metric_cache_v2_pruned/metadata/train_metric_cache_v2_pruned_metadata_node_0.csv",
    )
