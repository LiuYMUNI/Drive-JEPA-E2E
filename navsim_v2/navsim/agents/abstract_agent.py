...
class AbstractAgent(torch.nn.Module, ABC):
    ...
    def compute_trajectory(self, agent_input: AgentInput, past_ego_simulated_states=None, metric_cache=None, observation_interval=None) -> Trajectory:
        """
        ...
        features['past_ego_simulated_states'] = past_ego_simulated_states
        features['metric_cache'] = metric_cache 
        features['observation_interval'] = observation_interval
